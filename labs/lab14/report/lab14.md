...
Для запуска программы внутри отладчика ввёл команду run.(Ссылка: Рис. 7)

![Запуск отладчика и введённая команда run](image/7.png)

Рис. 7: Запуск отладчика и введённая команда run
...
Рис. 8: Результат выполнения команд в терминале
...
Рис. 9: Команда list с параметрами calculate.c:20,29
...
С помощью утилиты splint попробовал проанализировать коды файлов calculate.c и main.c. (Ссылка: Рис. 16)(Ссылка: Рис. 17)
