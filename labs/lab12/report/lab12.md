...
![Запуск созданного командного файла с соответсвующими аргументами и опциями](image/3.png)
...
Затем с помощью команды gcc скомпилировал её в исполняемый файл.

![Код программы написанный на Си](image/5.png)


Далее написал командный файл на bash (Ссылка: Рис.6), который вызывает программу на Си и, проанализировав её с помощью команды $?, выдает сообщение о том, какое число было введено. (Ссылка: Рис.7)
