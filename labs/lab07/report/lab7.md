...
```
```
Выведу на экран (по странично с пощью команды ) имена файлов из каталога /etc, начинающиеся с символа h.

![Использование конвейера (pipe) необходимых для выполнения задачи команд](image/.png)
